...
class WikiEvidens:
    def __init__(self, master):
        ...
        self.framedownloadspecialexportentry1.grid(row=1, column=1, columnspan=2)
        ...
        self.framedownloadspecialexportentry2.grid(row=2, column=1, columnspan=2)
        self.framedownloadspecialexportlabel4 = Label(self.framedownloadspecialexport, text="Page list:", anchor='center', font=self.font)
        self.framedownloadspecialexportlabel4.grid(row=3, column=0, columnspan=3, sticky=W)
        self.framedownloadspecialexportscrollbar = Scrollbar(self.framedownloadspecialexport)
        self.framedownloadspecialexportscrollbar.grid(row=4, column=2, sticky=W+E+N+S)
        self.framedownloadspecialexporttext = Text(self.framedownloadspecialexport, wrap=WORD, width=66, height=20, yscrollcommand=self.framedownloadspecialexportscrollbar.set)
        ...
        self.frameanalysisglobaloptionmenu1 = OptionMenu(self.frameanalysisglobal, self.frameanalysisglobaloptionmenu1var, self.frameanalysisglobaloptionmenu1var.get(), "global-activity-yearly", "global-activity-monthly", "global-activity-dow", "global-activity-hourly", "global-activity-all", "global-activity-regs-vs-anons", "global-reverts-evolution", "global-reverted-words", "global-newpages", "global-newusers", "global-graph-user-messages", "global-graph-user-edits-network", "global-nlp-mostusedwords", )
        ...
        self.frameanalysisusersoptionmenu1 = OptionMenu(self.frameanalysisusers, self.frameanalysisusersoptionmenu1var, self.frameanalysisusersoptionmenu1var.get(), "users-activity-yearly", "users-activity-monthly", "users-activity-dow", "users-activity-hourly", "users-activity-all", )
