...
class WikiEvidens:
    def __init__(self, master):
        ...
        self.framedownloadspecialexportlabel4 = Label(self.framedownloadspecialexport, text="\nPage list:", anchor='center', font=self.font)
        ...
        self.framedownloadspecialexporttext = Text(self.framedownloadspecialexport, wrap=WORD, width=66, height=25, yscrollcommand=self.framedownloadspecialexportscrollbar.set)
